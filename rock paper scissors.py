...
user_wins = 0 # สะสม ต้องอยู่นอก loop
com_wins = 0 # สะสม ต้องอยู่นอก loop

options = ['rock','paper','scissors'] # เป็นโครงสร้าง ต้องอยู่นอก loop


while True:
    user_pick = input('rock / paper / scissors or q') # generate ใหม่ทุกครั้งอยู่ใน loop
    random_number = random.randint(0,2) # generate ใหม่ทุกครั้งอยู่ใน loop
    com_pick = options[random_number]
